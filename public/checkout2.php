...
<body>
    <div class="wrapper">
        <div class="container">
            ...
            <section class="total">
                <form class="col-md-8 col-12 left" style="width: 100%; margin-top: 20px;" method="post" id="form">
...
<div class="nguoilon">
    ...
    <label for="">Viết thông tin của từng người theo công thức thức họ tên - tuổi - giới
        tính</label><br>
    <textarea class="form-control" style="height: 200px;border: 1px solid gray;" name="nguoilon" id="" cols="100"
        rows="5"></textarea>
</div>
<div class="trenho">
    ...
    <label for="">Viết thông tin của từng người theo công thức thức họ tên - tuổi - giới
        tính</label><br>
    <textarea class="form-control" style="height: 200px;  border: 1px solid gray;" name="trenho" id="" cols="100"
        rows="5"></textarea>
</div>
<div class="treem">
    <h3>Thông tin liên lạc trẻ em(< 5 tuổi)</h3>
            <label for="">Viết thông tin của từng người theo công thức thức họ tên - tuổi -
                giới
                tính</label><br>
            <textarea class="form-control" style="height: 200px; border: 1px solid gray;" name="treem" id="" cols="100"
                rows="5"></textarea>
</div>
    ...
    <div class="group-checkout">
        ...
        <div class="product-1">
            <div class="product-image-1">
                <img src='../pimages/<?php echo $tour["PackageImage"]; ?>' class="img-fluid" alt="image">
            </div>
